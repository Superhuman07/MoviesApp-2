...
public class Downloaders {
    private final static String LOG_TAG = Downloaders.class.getSimpleName();
    ...
    public static MovieItem[] getMovieDataFromJson(String movieJsonStr) {
        ...
        try {
            ...
            flavorMovies = new MovieItem[movieArray.length()];
            ...
            for (int i = 0; i < movieArray.length(); i++) {
                ...
                movie.setPopularity((double) jsonMovieObject.getDouble(OWN_POPULARITY));
                movie.setVoteAverage((double) jsonMovieObject.getInt(OWN_VOTE_AVERAGE));
